...
{
  const branchA = evaluatePortfolioCircuit({ date: '2026-07-17', brokerTotal: 3841267, cash: 1403569, positionsValue: 2437598, externalCash: 0, portfolioTotal: 3841267, peakAssets: 4300000, peakBasis: 'PORTFOLIO' })
  check('分支A（高点430万）：回撤10.7%未触发', branchA.positionCap === 1, branchA.detail)
  const branchB = evaluatePortfolioCircuit({ date: '2026-07-17', brokerTotal: 3841267, cash: 1403569, positionsValue: 2437598, externalCash: 0, portfolioTotal: 3841267, peakAssets: 4640000, peakBasis: 'PORTFOLIO' })
