...
// "更聪明"，把叙事台账的评分接进候选池排序 —— 那时文档还在，约束已经没了。
{
  ...
  ok('字段名表覆盖当前研究模块导出的关键字段',
    ['hypotheses', 'attribution', 'alternatives', 'link2', 'causal', 'portfolioDefense', 'ownershipPhilosophy', 'aiPhaseTwo', 'aiFinancingQuality', 'dalioPressureTest', 'aiFourActs', 'aiActTwoPool', 'capexLadder', 'macroRiskLights', 'marketStructureWatch']
